...
public class AddReminderActivity extends AppCompatActivity {
    ...
    private View buildContent() {
        ...
        insuranceLayout=addLayout(content,AppPreferences.tr(this,"Страховка, ₽","Insurance, ₽")); attachInfo(insuranceLayout,AppPreferences.tr(this,"Страховка","Insurance"),AppPreferences.tr(this,"Введите стоимость страховки. Она учитывается в общей переплате независимо от способа оплаты. Переключатель ниже определяет только, включать ли страховку в финансируемую сумму.","Enter the insurance cost. It is included in total overpayment regardless of how it is paid. The switch below only controls whether insurance is included in the financed amount.")); insuranceInput=addInput(insuranceLayout,InputType.TYPE_CLASS_NUMBER|InputType.TYPE_NUMBER_FLAG_DECIMAL);UiUtils.attachMoneyFormatting(insuranceInput);
